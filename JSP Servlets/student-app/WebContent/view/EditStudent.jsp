...
Id:<span>Name:<input type="text" class="form-control" name="id" value=<%= (request.getParameter("id")==null)?"":(request.getAttribute("id")) %> readonly="readonly"></span></div>
<div class="form-inline">
...
<div class="form-inline">
<input type="submit" class="btn btn-primary" value="Update Student"></div>
</form>
