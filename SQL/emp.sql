CREATE TABLE EMP (EMPNO int NOT NULL, ENAME varchar(10), JOB varchar(9), MGR int,
 HIREDATE DATE, SAL INT, COMM INT, DEPTNO integer NOT NULL,
...
INSERT INTO EMP VALUES (7900,'JAMES','CLERK',7698,'1918-12-3',950,NULL,30);
