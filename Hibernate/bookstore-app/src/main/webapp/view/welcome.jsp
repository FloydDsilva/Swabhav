...
<body>
	...
	<header><h2><a href="bookCategory?category=Comedy">Comedy</a></h2></header>
		<article class="row">
	...
	<section class="container-fluid">
	<header><h2><a href="bookCategory?category=Romance">Romance</a></h2></header>
		<article class="row">
			...
			<div class="col-xs-3"
				style="height: 250px; border-radius: 20px;">
				<center style="margin-top: 50px;">
					<a href="bookCategory?category=Romance">
					<h2 class="glyphicon glyphicon-plus"></h2>
					<br>
					<br> <span>View more books</span></a>
				</center>
			</div>
		</article>
	</section>
	...
	<section class="container-fluid">
	<header><h2><a href="bookCategory?category=Thriller">Thriller</a></h2></header>
		<article class="row">
			...
			<div class="col-xs-3"
				style="height: 250px; border-radius: 20px;">
				<center style="margin-top: 50px;">
					<a href="bookCategory?category=Thriller">
					<h2 class="glyphicon glyphicon-plus"></h2>
					<br>
					<br> <span>View more books</span>
					</a>
